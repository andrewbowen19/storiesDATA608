...
fed$fed_fundsrate <- as.double(fed$value)
head(fed)
```
...
ggplot(fed, aes(x=date, y=fed_fundsratee)) + 
  geom_line() + labs(y="Federal Funds Rate", x="Month", title ="Effective Federal Funds Rate over Time", substitle="Recent federal interest rates")
```
